...
<body>
	...
	<main id="content" role="main" class="main-mp">
		...
		<section class="project-overview centered" id="overview">
			...
			<p>For this project, the goal was to create a single page scrolling website with a form. I experimented with skrollr, a javascript scrolling library, as well as css animations.</p>

			<a href="http://gtong.htpwebdesign.ca/machu-picchu/" class="view-live">view live</a>
		</section>
